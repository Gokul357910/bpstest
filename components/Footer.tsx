      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-14 grid md:grid-cols-[1.2fr_1fr_1fr] gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-[14px]">
            <li><a href="#about" className="hover:text-green transition">About the College</a></li>
            <li><a href="#mission" className="hover:text-green transition">Mission &amp; Vision</a></li>
            <li><a href="#departments" className="hover:text-green transition">Departments</a></li>
            <li><a href="#admissions" className="hover:text-green transition">Admissions</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-[14px]">
            <li>
              <a href={contact.admissionHotlineHref} className="hover:text-green transition">
                {contact.admissionHotline}
              </a>
            </li>
            <li>
              <a href={`mailto:${contact.email}`} className="hover:text-green transition">
                {contact.email}
              </a>
            </li>
          </ul>
